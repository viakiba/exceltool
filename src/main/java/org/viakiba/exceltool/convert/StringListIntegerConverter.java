...
public class StringListIntegerConverter implements Converter<List> {
    private static Logger logger = LoggerFactory.getLogger(StringListIntegerConverter.class);
    @Override
    ...
    public List convertToJavaData(CellData cellData, ExcelContentProperty contentProperty,
        ...
        try {
            ...
            String stringValue = GenJavaFile.getCellData2String(cellData);
            ...
            for(String s:split){
                ...
                longs.add(Integer.parseInt(s.split("\\.")[0]));
            }
            return longs;
        }catch (Exception e){
            e.printStackTrace();
