...
public class GenGoFile {
    ...
    private static void initConfig() throws MalformedURLException {
        ...
        if (StringUtils.isEmpty(property)) {
            throw new RuntimeException("请使用vm参数 -Dgen.config.configPath=/Users/dd/Desktop/exceltool/go/config/excel2go.xml  设置生成代码的配置路径");
        }
    ...
    public static void genSingleCodeExcel(ClassBean classBean) throws Exception {
        ...
        File fileName = new File(genBeanPath + classBean.getClassName() + ".go");
